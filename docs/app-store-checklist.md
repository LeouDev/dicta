...
- ✅ A moderation routine: docs/production.md → Moderation. Every report emails support@air-rally.com with the commands to act on it (since 2026-09-26), and a saved query lists open reports. ⚠️ Act on alerts within 24 hours. There's no in-app admin tool.
