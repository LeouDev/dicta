...
- **Stories, Threads and X:** the share sheet sends the card to Instagram or Facebook Stories as a sticker over a blurred copy of itself (Meta's Sharing to Stories, through the local module `modules/pasteboard`), and opens Threads or X with the quote and the post's link. See docs/production.md.
